        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('user.credentials.store') }}">
                        @csrf

                        <!-- General API Validation Error Display -->
                        @if ($errors->has('error'))
                        ...
                        <div>
                            ...
                            <select id="platform_id" name="platform_id"
                                ...
                                required autofocus>
                                <option value="" disabled selected>Select an HR platform</option>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="username" class="block mt-1 w-full" type="text" name="username"
                                :value="old('username')" placeholder="Enter your HR platform username" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="password" class="block mt-1 w-full" type="password" name="password"
                                placeholder="We encrypt your password securely" required autocomplete="new-password" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="location"
                                ...
                                name="location" :value="old('location')" readonly required
