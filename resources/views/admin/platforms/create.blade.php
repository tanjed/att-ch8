                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.platforms.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Upload an image file (PNG, JPG,
                                SVG) for the portal list.</p>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="authentication_curl_template" name="authentication_curl_template" rows="6"
                                class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block w-full">{{ old('authentication_curl_template') }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="auth_token_key" class="block mt-1 w-full" type="text"
                                name="auth_token_key" :value="old('auth_token_key')"
                        ...
                        <div class="mt-4 border-t pt-4">
                            ...
                            <textarea id="refresh_curl_template" name="refresh_curl_template" rows="4"
                                class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block w-full">{{ old('refresh_curl_template') }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="refresh_token_key" class="block mt-1 w-full" type="text"
                                name="refresh_token_key" :value="old('refresh_token_key')"
                        ...
                        <div class="mt-4 border-t pt-4">
                            ...
                            <textarea id="calendar_api_curl_template" name="calendar_api_curl_template" rows="4"
                                class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block w-full">{{ old('calendar_api_curl_template') }}</textarea>
